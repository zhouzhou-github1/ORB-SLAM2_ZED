...
//getcwd(char *buf,size_t size);会将当前的工作目录绝对路径复制到参数buf 所指的内存空间，参数size 为buf 的空间大小。

    cout << "The current dir is : " << cwd << endl; 
///////////    string strPathSystemSetting = cwd + "/" + strSettingsFile.c_str();			/////////////////相机参数地址幅值
...
//c_str()函数返回一个指向正规C字符串的指针, 内容与本string串相同    
    ...
    mySystemSetting->LoadSystemSetting(strPathSystemSetting);		////////////////////////设置相机参数 地址strPathSystemSetting
    ...
    cout << "Set pointers between threads" << endl;  
